...
export const coverageDomains: CoverageDomain[] = [
  ...
  },
  {
    ...
    nextTask: "Documentar agregações, propriedades obrigatórias, filtros e testes de contrato.",
    openApiAnchor: "openapi",
    flowStage: "Métrica",
  },
  {
  ...
  },
  {
    ...
    nextTask: "Criar guia de onboarding, alteração de plano e impacto temporal na cobrança.",
    openApiAnchor: "openapi",
    flowStage: "Cobrança",
  },
  {
